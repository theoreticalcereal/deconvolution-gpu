...
1. Go to the **My Project** page in Astrocyte.
   ...
   ![Screenshot: Astrocyte My Project page](images/astrocyte-my-project-page.png)

2. Scroll to the create project section.

3. Enter a project name, then press **Create**.

   ![Screenshot: Create project section with project name and Create button](images/astrocyte-create-project-section.png)

4. After the project opens, find the **Input** area and click **Upload**.

   ![Screenshot: Upload button under the project Input area](images/astrocyte-project-input-upload.png)
